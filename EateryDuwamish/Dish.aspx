...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
     <link rel="stylesheet" type="text/css" href="assets/css normal/DishDesign.css" />
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">
                                <asp:Button runat="server" ID="btnSave" CssClass="btn btn-primary" Width="100px"
                                    Text="SAVE" OnClick="btnSave_Click" ValidationGroup="InsertUpdateDish"></asp:Button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        <th aria-sort="ascending" style="" colspan="1" rowspan="1"
                                            tabindex="0" class="sorting_asc center"></th>
                                        <th aria-sort="ascending" style="" colspan="1" rowspan="1" tabindex="0"
                                            class="sorting_asc text-center">Dish Name
                                        </th>
                                        <th aria-sort="ascending" style="" colspan="1" rowspan="1" tabindex="0"
                                            class="sorting_asc text-center">Dish Type
                                        </th>
                                        <th aria-sort="ascending" style="" colspan="1" rowspan="1" tabindex="0"
                                            class="sorting_asc text-center">Price
                                        </th>
                                        <th aria-sort="ascending" style="" colspan="1" rowspan="1" tabindex="0"
                                            class="sorting_asc text-center">Toggle
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <tr class="odd" role="row" runat="server" onclick="">
                                <td>
                                    <div style="text-align: center;">
                                        <asp:CheckBox ID="chkChoose" CssClass="checkDelete" runat="server"></asp:CheckBox>
                                    </div>
                                </td>
                                <td>
                                    <asp:Literal ID="lbDishName" runat="server" ></asp:Literal>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:LinkButton ID="RecipeBtn" runat="server" OnClick="RecipeBtn_Click" CommandName="TRANSFER" CommandArgument='<%# Eval("DishID") %>'>Recipes</asp:LinkButton>
                                    <asp:LinkButton ID="EditBtn" runat="server" OnClick="EditBtn_Click" CommandName="EDIT" CommandArgument='<%# Eval("DishID") %>'>Edit</asp:LinkButton>                                                                       
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
