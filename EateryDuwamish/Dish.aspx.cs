...
namespace EateryDuwamish
{
    public partial class Dish : System.Web.UI.Page
    {
        ...
        protected void rptDish_ItemCommand(object sender, RepeaterCommandEventArgs e)
        {
            ...
            {
                string dishID = e.CommandArgument.ToString();
                Response.Redirect("RecipePage.aspx?ID=" + dishID);
            }
        }
        #endregion
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int rowAffected = new DishSystem().DeleteDishAll(deletedIDs);
                if (rowAffected <= 0)
            ...
            {
                notifDish.Show($"ERROR DELETE DATA: No Item Selected", NotificationType.Danger);
            }
        }
        #endregion
